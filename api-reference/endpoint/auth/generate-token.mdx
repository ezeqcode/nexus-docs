...
api: "POST https://api.revenda.nexus/auth/static-token"
authMethod: "none"
description: "Este endpoint permite gerar um token fixo de autenticação para acessar a API da plataforma Nexus."
---
