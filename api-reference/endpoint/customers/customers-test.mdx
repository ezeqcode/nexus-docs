...
sidebarTitle: "/lines/test"
api: "POST https://api.revenda.nexus/lines/test"
authMethod: "authorization"
description: "Este endpoint permite gerar um cliente de teste na plataforma Nexus."
---
...
<ParamField body="testDuration" type="number" placeholder="1" required>
  Duração do teste em dias. Este campo é obrigatório.
</ParamField>
