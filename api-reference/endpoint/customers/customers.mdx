...
sidebarTitle: "/lines/active"
api: "POST https://api.revenda.nexus/lines/active/:id-client"
authMethod: "authorization"
description: "Este endpoint permite ativar um cliente de teste, tornando-o um usuário oficial na plataforma Nexus."
---
...
<ParamField body="username" type="string" placeholder="1230921" required>
  Nome de usuário do cliente a ser ativado.
</ParamField>

<ParamField body="password" type="string" placeholder="7241558" required>
  Senha do cliente.
</ParamField>
...
```json
POST https://api.revenda.nexus/lines/active/505
Headers:
{
